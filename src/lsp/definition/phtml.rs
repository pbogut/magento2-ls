...
pub fn find_admin(state: &ArcState, mod_name: &str, template: &str) -> Vec<Location> {
    let mut result = vec![];
...
pub fn find_front(state: &ArcState, mod_name: &str, template: &str) -> Vec<Location> {
    let mut result = vec![];
...
pub fn find_base(state: &ArcState, mod_name: &str, template: &str) -> Vec<Location> {
    let mut result = vec![];
